...
if __name__ == '__main__':
    ...
    for file in os.listdir('reads'):
        ...
        query_path = r"C:/Users/seraphinbassas/PycharmProjects/561_final_project/reads/{}.fa".format(read_name)
        out_path = r"C:/Users/seraphinbassas/PycharmProjects/561_final_project/new_results/{}.xml".format(read_name)
        if not os.path.isfile(r"C:/Users/seraphinbassas/PycharmProjects/561_final_project/new_results/{}.xml".format(read_name)):
            cl = NcbiblastnCommandline(cmd=blastn_path, query=query_path, subject=subject_path, out=out_path, outfmt=5)
            cl()

    hsp_per_read = {}
    for result in os.listdir('new_results'):
        handle = open(os.path.join('new_results', result), 'r')
